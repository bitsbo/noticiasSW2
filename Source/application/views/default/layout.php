...
<head>
    ...
    <title><?php echo (isset($data['title']) ? $data['title'] : "Noticias Bitsbo") ?></title>
                ...
                <nav class="navbar navbar-default navbar-fixed-top">
                    <div class="container">
                        <div class="navbar-header">
                            ...
                            <?php endif; ?>
                            <a href="<?php echo base_url(); ?>" class="navbar-brand cursive logo">Noticias SW2</a>
                        </div>
                        <?php if(!isset($data['pdf']) || $data['pdf'] == FALSE): ?>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 text-right">
                    <p>
                        &copy; <?php echo date('Y'); ?> Noticias SW2. All rights reserved.<br />
                        Application developed by <a href="http://bitsbo.com/" target="_blank">victor- ZZepita</a>.
                    </p>
                </div>
            </div>
        </div>
